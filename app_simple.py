...
from utils.audio_control_simple import AudioController
from utils.music_recognition_simple import MusicRecognitionService
...
if __name__ == '__main__':
    try:
        logger.info("Starting Pi-DAD on port 5000...")
